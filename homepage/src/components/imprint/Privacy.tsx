export function Privacy() {
    ...
    return (
        <div id={"privacy"}>
            ...
            <p>At Yacht.Chat, accessible from https://www.yacht.chat, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                Yacht.Chat and how we use it.</p>
            ...
            <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to
                contact us. Our Privacy Policy was generated with the help of <a
                    href="https://www.gdprprivacypolicy.net/">GDPR Privacy Policy Generator from
                    GDPRPrivacyPolicy.net</a></p>

            <h2>General Data Protection Regulation (GDPR)</h2>
            <p>We are a Data Controller of your information.</p>

            <p>Yacht.Chat legal basis for collecting and using the personal information described in this Privacy Policy
            ...
            <p>Yacht.Chat will retain your personal information only for as long as is necessary for the purposes set
            ...
            <p>Yacht.Chat follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, Yacht.Chat uses 'cookies'. These cookies are used to store information including
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on Yacht.Chat, which are sent directly to
            ...
            <p>Note that Yacht.Chat has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>Yacht.Chat's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>Yacht.Chat does not knowingly collect any Personal Identifiable Information from children under the age
            ...
            <p>Our Privacy Policy created at GDPRPrivacyPolicy.net) applies only to our online activities and is valid
                ...
                Yacht.Chat. This policy is not applicable to any information collected offline or via channels other
                than this website.</p>
