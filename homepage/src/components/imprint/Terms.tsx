    ...
    return (
        <div id={"terms"}>
            <div className={"contentWrapper"}>
                ...
                <p>By accessing this Website, accessible from https://www.yacht.chat, you are agreeing to be bound by
                    these
                ...
                <p>This will let Yacht.Chat to terminate upon violations of any of these restrictions. Upon termination,
                    ...
                    possession whether it is printed or electronic format. These Terms of Service have been created with
                    the
                    help of the <a href="https://www.termsofservicegenerator.net">Terms Of Service Generator</a>.</p>

                <h2>3. Disclaimer</h2>

                <p>All the materials on Yacht.Chat’s Websites are provided "as is". Yacht.Chat makes no warranties, may
                    it be
                    expressed or implied, therefore negates all other warranties. Furthermore, Yacht.Chat does not make
                    any
                ...
                <p>Yacht.Chat or its suppliers will not be held accountable for any damages that will arise with the use
                    or
                ...
                <p>The materials appearing on Yacht.Chat’s Website may include technical, typographical, or photographic
                    errors. Yacht.Chat will not promise that any of the materials on this Website are accurate,
                    complete, or
                ...
                <p>Yacht.Chat has not reviewed all of the sites linked to its Website and is not responsible for the
                    contents of any such linked site. The presence of any link does not imply endorsement by Yacht.Chat
                    of
                    the site. The use of any linked website is at the user’s own risk.</p>

                <h2>7. Site Terms of Use Modifications</h2>

                <p>Yacht.Chat may revise these Terms of Use for its Website at any time without prior notice. By using
                    this
